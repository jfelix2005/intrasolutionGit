...
Uso: exec pr_Pase_SW_Inicia_Pase 1,'DMTPAS-541','Framework','0.0.2','Pase Dominiotech 542',1,'0.0.1',0,''
RESUMEN DE CAMBIOS
...
**********************************************************************************************************
*/ 
create proc pr_Pase_SW_Inicia_Pase
...
set @OBSERVACION = @ps_pase_id+'/'+@Tipo_Pase+'/'+@Version+'/'+@Descripcion_Pase+'/'+
